...
void pid_set_parameters() {
    pid_velocity.Kp = 1.5; // 1.5
    pid_velocity.Ki = 0.1; // 0.1
    pid_velocity.Kd = 0; 
    pid_velocity.integral = 0;
    pid_velocity.last_error = 0;
    pid_velocity.max_integral = 50.0; // 200
    pid_velocity.min_integral = -50.0;
    pid_velocity.max_u = 6.0;
    pid_velocity.min_u = -6.0;
    pid_velocity.dead_zone = 0;

    pid_position.Kp = 5.0; // 20.0
    pid_position.Ki = 0.0;
    pid_position.Kd = 0;
    ...
    pid_position.max_u = 3.0;
    pid_position.min_u = -3.0;
    ...
    pid_current_d.max_integral = 50.0;
    pid_current_d.min_integral = -50.0;
    pid_current_d.max_u = 6.0;
